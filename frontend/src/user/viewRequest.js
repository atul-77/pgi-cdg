...
export default function ViewRequest(){
    ...
    return(
        ...
        <div 
        style={{background: "#ffffff", fontFamily: "Muli", color:"white"}}>
            <Row style={headerDiv}>
            ...
            <Table style={{marginTop:"-350px",marginLeft:"400px",width:"650px",color:"white"}}>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell style={{width:"400px",color:"black"}}>
                            Name
                        </TableCell>
                ...
                <TableBody>
                    <TableRow style={{padding:"0px"}}>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;1</TableCell>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;ACT Tubes</TableCell>
                        <TableCell style={{padding:"0px",color:"black"}}>
                        &emsp;
                        {/* <Input
                        val={A1_1}
          ...
          <option value="other">other</option>
                    ...
                    <TableRow style={{marginTop:"0px"}}>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;2A</TableCell>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;Arterial line cannula (Adult)</TableCell>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;
          ...
          <option value="other">other</option>
                    ...
                    <TableRow style={{marginTop:"0px"}}>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;2B</TableCell>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;Arterial line cannula ( Pediatric)</TableCell>
                        <TableCell style={{padding:"0px",color:"black"}}>&emsp;
                            {/* <Input></Input> */}
                            <select onChange={(event)=>(setA2B_1(event.target.value))}>     
                        <option value="20G">20G</option>
          <option value="22G">22G</option>
          <option value="80mm length">80mm length</option>
          <option value="other">other</option>
          </select> 
                        </TableCell>
                        <TableCell style={{padding:"0px",color:"white"}}>&emsp;
